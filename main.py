...
judgements_sorted = get_judgements_sorted(judgements, vectors="/home/yichun/projects/information_retrieval/word_embedding/fasttext_model_50d.bin", method="cosine")
